...
pretrain_path=results/pretrain/final/hl-video_tef-pretrain_asr-bicmf_1-en_3-dec_3-tcl-hl-scsl-cal_0.2-slowfast_clip-2024_11_29_13_39_52/model_best.ckpt
...
--exp_id ft_asr-bicmf_${bicmf_layers}-en_${enc_layers}-dec_${dec_layers}-tcl-hl-scsl-cal_${contrastive_align_loss_coef}-${v_feat_types} \
--device 0 \
--hidden_dim 256 \
${@:1}
