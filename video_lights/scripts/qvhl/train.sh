...
#t_feat_types=clip
t_feat_types=clip
results_root=results/lol/Final
exp_id=exp

######## data paths
#train_path=data/lol/highlight_train_release.jsonl
...
#train_path=data_ez/EZ_simpledata/highlight_train_release_ez.jsonl
#train_path=data/highlight_train_release_paraphrased.jsonl
#train_path=data/lol/highlight_train_release_paraphrased_openai.jsonl
train_path=data/lol/highlight_train_release.jsonl
#eval_path=data/lol/highlight_val_release_ez.jsonl
eval_path=data/lol/highlight_val_release.jsonl
eval_split_name=val
######## setup video+text features

#feat_root=../Datasets/qvhl/features
#feat_root=data_ez/features
feat_root=Datasets/lol/features
# video features
v_feat_dim=0
v_feat_dirs=()
...
--exp_id "複雜(t)_複雜(v)_V(sf_clip)_T(clip)_Pretrain(26_V(sf_clip_blip)_T(cliop_blip))_video(20)" \
--device 0 \
--hidden_dim 256 \
--seed ${seed} \
--resume ${PRETRAIN_CHECKPOINT_PATH}
${@:1}
