...
feat_root=../pretrain/features

cp -rf ${feat_root}/clip_query_features/* ${feat_root}/clip_sub_features/
...
--exp_id pretrain_asr-bicmf_${bicmf_layers}-en_${enc_layers}-dec_${dec_layers}-tcl-hl-scsl-cal_${contrastive_align_loss_coef}-${v_feat_types} \
--device 0 \
--hidden_dim 256 \
${@:1}
